...
_AUTO_META = {
    ...
    "location_phone_value": ("all", 110, 0, "Подтверждённый номер владельца Telegram-аккаунта"),
    "location_phone_label": ("all", 110, 0, "Подпись после подтверждённого номера"),
    "location_phone_request": ("all", 110, 0, "Запрос контакта после каждой полученной локации"),
