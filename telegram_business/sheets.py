...
_AUTO_META = {
    ...
    "delivery_status_pending": (
        "all", 100, 0, "Ожидаем курьера; не диалоговый автоответ",
    ),
    "delivery_status_picked_up": (
        "all", 100, 0, "Назначенный курьер забрал товар; не диалоговый автоответ",
    ),
    "delivery_status_on_way": (
        "all", 100, 0, "Назначенный курьер выехал; имя, телефон и подготовка к получению",
    ),
    "delivery_status_completed": (
        "all", 100, 0, "Товар доставлен; ссылка на отзыв",
    ),
    "delivery_status_cancelled": (
        "all", 100, 0, "Подтверждённая отмена активной доставки",
    ),
