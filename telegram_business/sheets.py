...
_AUTO_META = {
    ...
    "delivery_status_pending": (
        "all", 100, 0, "Заказ передан в службу доставки; не диалоговый автоответ",
    ),
    "delivery_status_picked_up": (
        "all", 100, 0, "Курьер получил товар; не диалоговый автоответ",
    ),
    "delivery_status_on_way": (
        "all", 100, 0, "Курьер выехал; не диалоговый автоответ",
    ),
    "delivery_status_completed": (
        "all", 100, 0, "Заказ доставлен; не диалоговый автоответ",
    ),
