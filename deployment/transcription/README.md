...
Limits: CPU-int8 Whisper small plus CPU-int8 Uzbek Callcenter Medium, pyannote
batch 1, CPU threads 2, 1.5 CPU quota, 4.5 GiB RAM, at most 512 MiB container swap. Calls longer than
...
Uzbek Callcenter Whisper Medium and Russian-only Whisper small. This deliberately trades some speed
