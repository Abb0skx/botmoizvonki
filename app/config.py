...
class Settings:
    ...
    def load(cls) -> "Settings":
        ...
        orders_channel_id = os.getenv("DELIVERY_ORDERS_CHANNEL_ID", "").strip()
        if not token:
        ...
        if not orders_channel_id:
            raise RuntimeError("DELIVERY_ORDERS_CHANNEL_ID is not set")
        try:
        ...
        return cls(
            ...
            orders_channel_id=parsed_orders_channel_id,
