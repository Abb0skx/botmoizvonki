...
def _final_delivery(
    ...
    if completion is not None:
        completion_courier_id = getattr(completion, "courier_id", None)
        completion_courier_name = getattr(completion, "courier_name", None)
        if completion_courier_id is not None:
            courier_id = completion_courier_id
            courier_name = completion_courier_name
