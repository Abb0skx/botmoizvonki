...
COURIERS: tuple[CourierOption, ...] = (
    CourierOption(user_id=7636344727, name="Olmas", group_id=-1004417796153),
    CourierOption(user_id=202134293, name="Abbos", group_id=-1003918562868),
    CourierOption(user_id=1799690992, name="Muzrob Oka", group_id=-1004404461980),
)
